...
public static partial class UIToolKitExtensions
{
    ...
    public static void RegisterOnClickOutside(this VisualElement e, Action action)
    {
        ...
        {
            if (evt.button == 0 && !e.layout.Contains(evt.mousePosition))
            {
                action?.Invoke();
            }
        }
    ...
    public static void Callback(this VisualElement e, EventCallback<KeyDownEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<KeyUpEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<GeometryChangedEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<MouseDownEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<MouseUpEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<MouseMoveEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<MouseEnterEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<MouseLeaveEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<WheelEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<FocusOutEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<FocusInEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<BlurEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<FocusEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<AttachToPanelEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<DetachFromPanelEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<CustomStyleResolvedEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<ExecuteCommandEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<ValidateCommandEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<InputEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback(this VisualElement e, EventCallback<ClickEvent> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback<T>(this VisualElement e, EventCallback<ChangeEvent<T>> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) => e.RegisterCallback(action, trickleDown);

    public static void Callback<T>(this VisualElement e, EventCallback<T> action,
        TrickleDown trickleDown = TrickleDown.TrickleDown) where T : EventBase<T>, new()
